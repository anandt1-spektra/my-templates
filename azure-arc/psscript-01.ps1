...
$templateBaseUrl = "https://raw.githubusercontent.com/CloudLabsAI-Azure/azure_arc/refs/heads/backup/azure_jumpstart_localbox/"
...
$WebClient.DownloadFile("https://experienceazure.blob.core.windows.net/templates/sovereign-private-cloud-with-azure-local/labfiles/Policy-allowed-Confidential-Compute.json","C:\Users\Policy-allowed-Confidential-Compute.json")
$WebClient.DownloadFile("https://experienceazure.blob.core.windows.net/templates/sovereign-private-cloud-with-azure-local/labfiles/Policy-allowed-location.json","C:\Users\Policy-allowed-location.json")
$WebClient.DownloadFile("https://experienceazure.blob.core.windows.net/templates/sovereign-private-cloud-with-azure-local/labfiles/Policy-allowed-tag-enforcement.json","C:\Users\Policy-allowed-tag-enforcement.json")
